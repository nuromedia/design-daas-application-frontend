...
function ObjectEnvironmentSetupEdit() {
    ...
    const objectID = localStorage.getItem("env-object-id")
    const objectENVName = localStorage.getItem("env-name")
    const objectENVNameObject = localStorage.getItem("env-name-object")
    const objectState = localStorage.getItem("environment-type-mode")
    const objectCFGApps = localStorage.getItem("env-apps")
    const objectCFGTasks = localStorage.getItem("env-tasks")
    const objectCFGTarget = localStorage.getItem("env-target")
    ...
    useEffect(() => {
        ...
        setVMEnvironmentNameAll(objectENVName)
        setVMIDPhasesEnvironmentCreate(objectID);
        setVMNamePhasesEnvironmentCreate(objectENVName)
        setVMPhasesIDCFGTarget(objectID);
        setVMPhasesENVCFGTarget(objectENVName);
        setVMPhasesNameCFGTarget(JSON.parse(objectCFGTarget).name);
        setVMPhasesCommandCFGTarget(JSON.parse(objectCFGTarget).cmd);
        setVMPhasesArgumentsCFGTarget(JSON.parse(objectCFGTarget).args);
        setVMPhasesIDCFGTarget(objectID);
        setVMPhasesENVCFGTarget(objectENVName);
        setVMPhasesIDCFGApplist(objectID);
        setVMPhasesENVCFGApplist(objectENVName);
        setVMPhasesNameCFGApplist(JSON.parse(objectCFGApps).name);
        setVMPhasesCommandCFGApplist(JSON.parse(objectCFGApps).cmd);
        setVMPhasesArgumentsCFGApplist(JSON.parse(objectCFGApps).args);
        setVMPhasesIDCFGTasklist(objectID);
        setVMPhasesENVCFGTasklist(objectENVName);
        setVMPhasesTypeCFGTasklist(JSON.parse(objectCFGTasks).type);
        setVMPhasesCommandCFGTasklist(JSON.parse(objectCFGTasks).cmd);
        setVMPhasesArgumentsCFGTasklist(JSON.parse(objectCFGTasks).args);
...
export default ObjectEnvironmentSetupEdit;

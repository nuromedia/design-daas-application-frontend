...
function InstanceRunning() {
    ...
    const instanceObjectID = localStorage.getItem("instance-object-id")
    const instanceEnv = localStorage.getItem("instance-env")
    ...
    return (
        <>
            <Header/>
            <ReactBootstrap.Container fluid={true} id="instanceRunning">
                {

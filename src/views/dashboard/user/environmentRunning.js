...
function EnvironmentRunning() {
    ...
    const environmentObjectID = localStorage.getItem("env-object-id")
    const environmentName = localStorage.getItem("env-name")
    const userDataID = localStorage.getItem("userDataID")
    const appViewerID = localStorage.getItem("environment-viewer-id");

    const envType = localStorage.getItem("environment-type-mode")
            ...
            axios.post(DEVELOPMENT + '/phases/environment_start', {
                ...
                .then(response => {
                    ...
                    if (response.status === 200 && response.data.response_code === 200) {
                        ...
                        localStorage.setItem("environment-viewer-id", response.data.response_url)
    ...
    return (
        <>
            <Header/>
            <ReactBootstrap.Container fluid={true} id="environmentRunning">
                {
...
export default EnvironmentRunning;

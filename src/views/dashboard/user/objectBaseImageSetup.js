...
function ObjectBaseImageSetup() {
    ...
    const objectBaseimageFinalize = event => {
    ...
    const objectBaseimageFinalizeSchema = Yup.object().shape({
        id: Yup.string()
            .required('ID invalid'),
    });
    ...
    return (
        <>
            <Header/>
            <ReactBootstrap.Container fluid={true} id="objectBaseImageSetup">
                <ReactBootstrap.Row>
                    <ReactBootstrap.Col xs={12} sm={12} md={12} lg={12} xl={12} className="text-left">
                        <h3>
                            {t('title-baseimage-create')}
                        </h3>
                    </ReactBootstrap.Col>
                    <ReactBootstrap.Col xs={12} sm={12} md={12} lg={12} xl={12} className="text-left">
                        {
                            textMessage === "Objekt verfügbar" || textMessage === "Object available"
                                ? (
                                    <>
                                        {t('object-available')}
                                    </>
                                                    ...
                                                    <ReactBootstrap.Row>
                                                        ...
                                                        <ReactBootstrap.Col xs={12} sm={12} md={6} lg={6} xl={6}>
                                                            <Field type="text" id="vm-env-phases-cfg-tasklist"
                                                                   ...
                                                                   value={objectENVName}
                                                                   onChange={changeVMPhasesENVCFGTasklist}
                                                                   disabled={true}/>
                                                        </ReactBootstrap.Col>
                                                        <div className="error-text">
                                                    ...
                                                    <ReactBootstrap.Row>
                                                        ...
                                                        <ReactBootstrap.Col xs={12} sm={12} md={6} lg={6} xl={6}>
                                                            <Field type="text" id="vm-env-phases-cfg-applist"
                                                                   ...
                                                                   value={objectENVName}
                                                                   onChange={changeVMPhasesENVCFGApplist}
                                                                   disabled={true}/>
                                                        </ReactBootstrap.Col>
                                                        <div className="error-text">
                                                    ...
                                                    <ReactBootstrap.Row>
                                                        ...
                                                        <ReactBootstrap.Col xs={12} sm={12} md={6} lg={6} xl={6}>
                                                            <Field type="text" id="vm-env-phases-cfg-target"
                                                                   name="vm-env-phases-cfg-target" value={objectENVName}
                                                                   onChange={changeVMPhasesENVCFGTarget}
                                                                   disabled={true}/>
                                                        </ReactBootstrap.Col>
                                                        <div className="error-text">
                ...
                <Formik
                    ...
                    validationSchema={objectBaseimageFinalizeSchema}
                    onSubmit={values => {
                        console.log(values.text);
                    }}
                >
                    {({errors, touched}) => (
                        <Form onSubmit={objectBaseimageFinalize} id="expert-mode-object-finalize">
                            <ReactBootstrap.Row>
                                <ReactBootstrap.Col xs={12} sm={12} md={12} lg={12} xl={12} className="text-left">
                                    <h3>
                                        {t('title-baseimage-finalize')}
                                    </h3>
                                </ReactBootstrap.Col>
                                <ReactBootstrap.Col xs={12} sm={12} md={12} lg={12} xl={12} className="text-left">
                                    {t('button-baseimage-finalize-info-text')}
                                </ReactBootstrap.Col>
                                <ReactBootstrap.Col xs={12} sm={12} md={12} lg={12} xl={12}>
                                    <ReactBootstrap.Button
                                        type="submit"
...
export default ObjectBaseImageSetup;

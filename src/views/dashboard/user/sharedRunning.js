...
function SharedRunning() {
    ...
    const connectionObjectID = localStorage.getItem("connection-shared-object-id")
    const connectionEnv = localStorage.getItem("connection-shared-env")

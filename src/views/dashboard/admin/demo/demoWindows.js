...
function DemoWindows() {
    ...
    const [selectedApplication, setSelectedApplication] = useState('\"C:/Program Files/Microsoft Office/root/Office16/Excel.exe\"');
    const [selectedOSSystem, setSelectedOSSystem] = useState("aaa-bbb-ccc-ddd-eee-win10");
    ...
    return (
        <>
            <Header/>
            <ReactBootstrap.Container fluid={true} id="demoOverviewWindows">
                {/*<ReactBootstrap.Row>
                ...
                <ReactBootstrap.Row>
                    <ReactBootstrap.Col xs={12} sm={12} md={12} lg={4} xl={4} className="text-center">
                        ...
                        <datalist id="select-os-system">
                            <option value="aaa-bbb-ccc-ddd-eee-win10">Windows 10</option>
                            <option value="aaa-bbb-ccc-ddd-eee-win11">Windows 11</option>
                        </datalist>
                            ...
                            <>
                                <ReactBootstrap.Col xs={12} sm={12} md={12} lg={4} xl={4} className="text-center">
                                    ...
                                    <datalist id="select-os-application">
                                        <option value='\"C:/Program Files/Microsoft Office/root/Office16/Excel.exe\"'>Excel</option>
                                        <option value='\"C:/Program Files/Notepad++/notepad++.exe\"'>Notepad++</option>
                                        <option value='\"C:/Program Files/Mozilla Firefox/firefox.exe\"'>Firefox</option>
                                    </datalist>
